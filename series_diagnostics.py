...
This module deliberately does not use AstrBot's logger.  The logger is kept
local to the plugin and only warning/error records plus explicit diagnostic
...
class DiagnosticBuffer(logging.Handler):
    """Small in-memory event store shared by the plugin logger and API."""
